...
function openPlayer(title, synopsis, id) {
    ...
    playerIframe.src = currentMode === 'movie' ? `https://player.autoembed.cc/embed/movie/${id}` : '';
...
function playEpisode() {
    ...
    if (season && episode) {
        playerIframe.src = `https://player.autoembed.cc/embed/tv/${currentItemId}/${season}/${episode}`;
    } else {
